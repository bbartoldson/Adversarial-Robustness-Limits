...
def load_cifar10s(data_dir, use_augmentation='base', use_consistency=False, aux_take_amount=None, 
                  ...
                  validation=False, EDM_50_amount=None, env=None, start_epoch=1):
    """
    ...
    train_dataset = SemiSupervisedCIFAR10(base_dataset='cifar10', root=data_dir, train=True, download=True, 
                                          ...
                                          add_aux_labels=True, aux_take_amount=aux_take_amount, validation=validation, EDM_50_amount=EDM_50_amount, env=env, start_epoch=start_epoch)
